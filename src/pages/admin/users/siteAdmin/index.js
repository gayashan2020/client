...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      >
        <Grid item>
          <Card sx={cardStyle} onClick={() => router.push(routes.ADMIN_USERS_SITE_ADMIN_REGISTER)}>
        ...
        <Grid item>
          <Card sx={cardStyle} onClick={() => router.push(routes.ADMIN_USERS_SITE_ADMIN_USER_MANAGEMENT)}>
            <CardActionArea sx={{ height: '100%' }}>
              <CardContent>
                <Typography variant="h5" component="div">
                  User Management
