...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      >
        <Grid item>
          <Card sx={cardStyle} onClick={() => router.push(routes.ADMIN_USERS_STUDENTS_REGISTER)}>
        ...
        <Grid item>
          <Card sx={cardStyle} onClick={() => router.push(routes.ADMIN_USERS_STUDENTS_USER_MANAGEMENT)}>
            <CardActionArea sx={{ height: '100%' }}>
              <CardContent>
                <Typography variant="h5" component="div">
                  User Management
