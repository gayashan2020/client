...
export default function UserManagement() {
  ...
  const handleEditOpen = (user) => {
    ...
    if (user.role === userRoles.CPD_PROVIDER) {
      setFullName(user.institution);
    ...
    <Layout>
      ...
      <Modal open={editOpen} onClose={handleEditClose} aria-labelledby="edit-modal-title" aria-describedby="edit-modal-description">
        ...
        >
          ...
          {editUser && (
            <form>
              {editUser.role !== userRoles.CPD_PROVIDER ? (<TextField
                margin="normal"
                fullWidth
                id="fullName"
                label="Full Name"
              ...
              <TextField
                ...
                required
              />
              {editUser.role !== userRoles.CPD_PROVIDER ? (
                <>
                  <TextField
                    margin="normal"
                    fullWidth
              ...
              <TextField
                ...
                required
              />
              {editUser.role === userRoles.STUDENT ? (<>
                <TextField
                  margin="normal"
                  fullWidth
                  id="batch"
              ...
              {editUser.role === userRoles.CPD_PROVIDER ? (<TextField
                ...
                label="CPD Provider Register Number"
